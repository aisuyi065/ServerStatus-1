...
```
mkdir sss && cd sss && wget --no-check-certificate https://raw.githubusercontent.com/aisuyi065/ServerStatus-1/master/sss.sh && chmod +x ./sss.sh && ./sss.sh YOUR_TG_CHAT_ID YOUR_TG_BOT_TOKEN
